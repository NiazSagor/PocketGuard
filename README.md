...
<div align="center">
  <img src="android/app/src/main/res/mipmap-xxxhdpi/ic_launcher_round.png" alt="Image" style="border-radius: 50%; width: 150px; height: 150px;">
</div><br>
...
-   **State Management:** [Provider](https://pub.dev/packages/provider) & `ChangeNotifier` for reactive UI updates.

-   **Local Database:** SQLite (via `sqflite`) for 100% offline-first privacy.
